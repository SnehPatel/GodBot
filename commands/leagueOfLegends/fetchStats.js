...
module.exports = {
    ...
    execute(message, args) {
        ...
        //getting match id
        const getMatchid = await fetch(`https://americas.api.riotgames.com/lol/match/v5/matches/by-puuid/${getPuuid.puuid}/ids?start=0&count=1&api_key=RGAPI-d0b3162d-adeb-48ec-8714-bc88efe31cd8`).then(response => response.json());
        // console.log(getMatchid[0]);

        //getting a match
        const getLastMatch = await fetch(`https://americas.api.riotgames.com/lol/match/v5/matches/${getMatchid[0]}?api_key=RGAPI-d0b3162d-adeb-48ec-8714-bc88efe31cd8`).then(response => response.json());
